let recipes = [
        ...
        {id: 29,
        title:"Home-Style Pork Curry",
        intro:"Lighten up curry night with this healthy recipe.",
        ingr_search:["pork", "curry powder", "onion", "ginger", "fennel", "cumin", " red lentils", "baby aubergine" ],
        ingr:[
                "425g of pork fillet",
                ...
                "350g of baby aubergine, quartered",
                "1 reduced-salt vegetable stock cube",
        ],
        instr:[
                "Cut the pork into cubes.",
                "Toast and crush the spice.",
                "Chop the onion and ginger.",
                "Tip the pork into a bowl and stir in the curry powder and vinegar.",
                "Set aside. Heat the oil in a heavy-based pan and fry the onion and ginger for 10 mins, stirring frequently, until golden.",
                "Tip in the pork mixture and fry for a few mins more.",
                "Remove the pork and set aside. Stir in the toasted spices, then tip in the tomatoes, lentils and aubergine, and crumble in the stock cube.",
                "Cover and leave to simmer for 40 mins, stirring frequently, until the aubergine is almost cooked. If it starts to look dry, add a splash of water.",
                "Return the pork to the pan and cook for a further 10-20 mins until the pork is cooked and tender.",
        ],
        img:"img/gallery/pork_curry.jpg",
        calo:309,
        nutri:"Energy:309kcal, Fat:18g, Cabohydrate:13g, Protein:33g, Sugar:3g"},

        {id: 30,
        title:"Herby Garlic Rolled Pork with Apple Salad",
        intro:"Give pork a roll in herbs, it'll stay moist, and is great with the apple sauce.",
        ingr_search:["pork", "chives", "small bunch oregano", "garlic", " olive oil", "apples,", "lemon", ],
        ingr:[
                "2 pork tenderloin",
        ...
        instr:[
                "Chop garlic, chive, oregano.",
                "Heat oven to 170-190C.",
                "Slice both tenderloins along the entire length of the fillet, making sure not to slice all the way through, then open out flat.",
                "Place between pieces of cling film and flatten to 5mm thickness by beating with a rolling pin or meat mallet.",
                ...
                "Heat remaining oil in a heavy roasting tin over a medium heat, then brown the loins on each side, turning frequently, for about 5 mins.",
                "Transfer to the oven and roast for 15-20 mins. Cover loosely with foil for 5 mins, then slice.",
        ...
        img:"img/gallery/pork_herby.jpg",
        calo:368,
        nutri:"Energy:368kcal, Fat:18g, Cabohydrate:14g, Protein:37g, Sugar:0g"},

        {id: 31,
        title:"Pork Noodle Stir-fry",
        intro:"Whip up this filling pork noodle stir-fry for a quick and easy midweek meal. It takes just 30 minutes to make, so is great for busy evenings.",
        ingr_search:["sesame oil", "pork", "egg noodles", "ginger", "garlic", "stir-fry veg"],
        ingr:[
        ...
        instr:[
                ...
                "Add the mince, break it up with a spoon and fry over a high heat for about 8 mins until browning. While the meat cooks, boil a kettle, then pour the hot water over the noodles.",
                "Set aside for 5-10 mins to soften.",
                "Add the ginger, garlic and veg to the pan and stir-fry for 2-3 mins.",
                "Mix 1 tbsp soy sauce with the cornflour to make a paste. Add the remaining soy sauce, the chilli sauce and 2 tbsp water.",
        ...
        img:"img/gallery/pork_stir.jpg",
        calo:599,
        nutri:"Energy:599kcal, Fat:19g, Cabohydrate:74g, Protein:39g, Sugar:0g"},

        {id: 32,
        title:"Roast Pork with Couscous & Ginger Yogurt",
        intro:"Give your system a boost of iron with this low-fat yet satisfying roast pork recipe.",
        ingr_search:["pork", "cumin", "cinnamon", "ginger", "couscous", "sultanas", "lemon", "mint", "yogurt"],
        ingr:[
                "2 pork_fillets",
                ...
                "100g of sultanas",
                "1 lemon",
                "1 of small bunch mint, chopped",
                "200g of fat-free natural yogurt",
        ],
        instr:[
                "Grate the zest of a lemon.",
                "Juice the lemon",
                "Heat oven to 190C/170C fan/gas 5.",
                "Brown the pork in a non-stick frying pan over a high heat for 4-5 mins, turning twice.",
                "Mix the oil, 2 tsp cumin, cinnamon, 2 tsp ginger and some seasoning, then rub all over the pork. Transfer to a roasting tin and roast for 30-35 mins or until the juices run clear when the thickest part is pierced with a skewer.",
                ...
                "Stir the remaining ginger and a little seasoning into the yogurt.",
                "Thickly slice the pork and serve with the couscous and ginger yogurt.",
        ],
        img:"img/gallery/pork_yogurt.png",
        calo:284,
        nutri:"Energy:284kcal, Fat:6g, Cabohydrate:37g, Protein:23g, Sugar:0g"},
]
